...
class CardEvent extends React.Component {
	...
	O getDate(), por sua vez, equivale ao dia do mê	É lógico que em um site decente, o usuário não será obrigado a saber disso, por isso, nós criaremos arrays, que são conjuntos de informações compactas.
</label>
					<label> SESI SANTOS </label>
